      ...
      ingredientsLiA.forEach(function(item){
        item.addEventListener('click',function(event){
          if(window.innerWidth>900){
            ...
            section6Bg.setAttribute('style',`background-image:url("./assets/images/itemContent/ingredients/${itemIngredientsData[event.target.textContent]["ingredients-bg__pc"]}")`)
          }
          else{
            ...
            section6Bg.setAttribute('style',`background-image:url("./assets/images/itemContent/ingredients/${itemIngredientsData[event.target.textContent]["ingredients-bg__mobile"]}")`)
          }
