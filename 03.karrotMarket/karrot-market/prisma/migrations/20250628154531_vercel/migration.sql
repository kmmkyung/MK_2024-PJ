-- CreateEnum
CREATE TYPE "CategoryType" AS ENUM ('Furniture', 'Electronics', 'Home_Garden', 'Baby_Kids', 'Fashion', 'Health_Beauty', 'Hobbies', 'Books_Music', 'Pet', 'Other');

-- CreateEnum
CREATE TYPE "MessageType" AS ENUM ('TEXT', 'DEAL');
