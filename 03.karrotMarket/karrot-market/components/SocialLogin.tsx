  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-3 *:text-sm">
        <Link className="custom-link bg-slate-700 text-white hover:bg-slate-600 flex items-center justify-center gap-2" href='/github/start'>
          <GithubIcon />
          <span>Continue with Github</span>
        </Link>
        <Link className="custom-link text-black ring-2 ring-neutral-200 hover:bg-neutral-200 hover:ring-0 dark:text-white dark:hover:bg-white dark:hover:text-black flex items-center justify-center gap-2" href='/google/start'>
          <GoogleIcon />
