    ...
    <section className="setting-page pt-20">
      <form action={onSubmit} className="flex flex-col gap-5 md:flex-row">
        ...
        <div className="md:w-1/2 flex flex-col gap-3">
          ...
          <div>
          <textarea name="description" placeholder="게시글 내용을 작성해 주세요" value={description} required onChange={event => setDescription(event.target.value)} className="whitespace-pre-wrap align-middle h-40 text-sm bg-transparent rounded-md w-full ring-2 focus:ring-3 ring-neutral-400 focus:ring-primary border-none placeholder:text-neutral-400 transition-all">
          </textarea>
