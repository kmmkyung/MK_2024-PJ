    ...
    <section className="setting-page animate-pulse">
      ...
      {[...Array(5)].map((_,idx) => {
        ...
        <div className="*:rounded-lg flex flex-col">
          <div className="bg-neutral-400 dark:bg-neutral-700 h-6 md:h-7 w-40"></div>
          <div className="bg-neutral-200 dark:bg-neutral-500 h-4 md:h-5 w-20 mt-1"></div>
          <div className="bg-neutral-300 dark:bg-neutral-600 h-5 md:h-7 w-10 mt-2"></div>
        </div>
      </div>
      })}
      </div>
