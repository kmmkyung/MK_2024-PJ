    ...
    <div className="absolute z-[51] w-full h-full px-20 py-20 flex justify-center items-center md:px-10">
      ...
      <div className="relative rounded-lg overflow-hidden max-w-[1000px] w-full h-full no-scrollbar overflow-y-scroll md:overflow-y-visible flex md:flex-row flex-col">
        ...
        <div className="bg-white dark:bg-neutral-900 h-[calc(100vh-160px)] w-full md:h-full p-5">
          ...
          <div className="h-8 w-full rounded-md bg-neutral-400 dark:bg-neutral-700 mt-5 animate-pulse"></div>
          <div className="h-4 w-full rounded-md bg-neutral-300 dark:bg-neutral-600 mt-2 animate-pulse"></div>
          <div className="h-7 w-full rounded-md bg-neutral-300 dark:bg-neutral-600 mt-5 animate-pulse"></div>
          <div className="mt-5 h-[calc(100%-177px-80px-20px)] w-full rounded-md bg-neutral-300 dark:bg-neutral-600 animate-pulse"></div>
